    ...
    return (
      ...
      <AppBar className="Header" color="inherit">
        <Toolbar>
          ...
          <Button onClick={this.handleClickOnMap}>Карта</Button>
          <Button onClick={this.handleClickProfile}>Профиль</Button>
          <Button onClick={this.handleClickOnLogin}>Войти</Button>
        </Toolbar>
      </AppBar>
      {this.state.page}
      </div>
